export default function Auth() {
  return (
    <div>
      <h1 className="font-italics">AUTHORISATION</h1>
      <p>
      ...
      <p>
        I consent to the sharing/contionous sharing of my credit information
        with credit bureau and/or other regulatory authorities without further
        recourse to my execution of the document. The applicant understands that
        the signature under this loan application form does not guarantee
        reception of a loan from the Bank and that the Bank reserves the right
        to reject or adjust the loan request and terms of the transaction in
        line with its credit risk policies.
      </p>
    </div>
  );
}
